...
void parshl_synthesize_additive(
  ...
  auto synth_one_osc = [&](int Zosc) {
    ...
    // V1 correction: use fmod for full wrap robustness (handles any magnitude of Phs).
    // Simple subtraction only works when Phs ∈ [-SinSiz, 2·SinSiz); fmod is always correct.
