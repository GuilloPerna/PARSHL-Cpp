...
//
// STATUS: NOT CONNECTED TO MAIN ANALYSIS PIPELINE.
// Called only from the debug output block in parshl_audio_peaks.cpp (~L566).
// The pipeline uses Qinterp on magnitude (Step 3) only; Step 4 is not invoked.
// See docs/COMPLEX_PEAK_AUDIT.md §7 (Veredicto).
