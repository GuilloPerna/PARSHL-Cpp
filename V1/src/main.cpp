...
auto Nfft  = parshl_defaults::Nfft;//this does not change logic; only ensures that if nothing is passed via CLI, the program starts identically to historical PARSHL.
