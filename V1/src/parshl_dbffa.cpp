...
void DbFromInterleavedComplex(
  ...
  // SAIL: (i+1)/2 with i=1,3,5,... yields bins 1,2,3,...,Nspec.
  // Note: % in SAIL is integer division, NOT modulo (unlike C++).
  // Here we iterate directly by bin index I=1..Nspec (algebraically equivalent).
